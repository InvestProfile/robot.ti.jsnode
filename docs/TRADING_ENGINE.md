...
- Recent re-entry after any filled sell is blocked by default for 48 hours unless price confirms at least 1% above the latest sell. This prevents buying back lower/flat shortly after broker-stop exits such as recent RUAL/GMKN cases.
...
- `ROBOT_BUY_LOSS_GUARD_STOP_CLUSTER_EXTRA_BUFFER` — additional buy-score buffer for tickers/sectors with repeated or large stop-loss damage.
