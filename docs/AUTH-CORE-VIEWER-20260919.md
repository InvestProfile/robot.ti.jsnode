...
Исторический этап: 2026-09-20 пользователь разрешил выбранному subject
[обычный кабинет через SSO](AUTH-CORE-OPERATOR-20260920.md). Viewer-only
ограничения ниже больше не описывают доступ этого пользователя.
