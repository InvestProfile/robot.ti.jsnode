...
const safeConfig = (config: RobotConfig) => ({
    ...
    buyAntiFomoEnabled: config.buyAntiFomoEnabled,
    ...
    sectorPerformanceRiskEnabled: config.sectorPerformanceRiskEnabled,
    sectorPerformanceRiskEnforced: config.sectorPerformanceRiskEnforced,
    sectorPerformanceMinClosed: config.sectorPerformanceMinClosed,
    sectorPerformanceMinWinRatePercent: config.sectorPerformanceMinWinRatePercent,
    sectorPerformanceMinPnlRub: config.sectorPerformanceMinPnlRub,
